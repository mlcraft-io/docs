...
<Tabs
defaultValue="database-comparison"
groupId="database-type"
values={[
{ label: 'Application (Postgres/MySQL)', value: 'application' },
{ label: 'Analytical (BigQuery/Redshift)', value: 'analytical' },
]}
...
>   <TabItem value="yaml" markdown={true}>
  ...
  <TabItem value="javascript" markdown={true}>
    ```javascript
    cube(`orders`, {
        sql_table: `orders`,
...
<Tabs
defaultValue="preaggregation-example"
groupId="preaggregation-example"
values={[
{ label: 'YAML', value: 'yaml' },
{ label: 'JavaScript', value: 'javascript' },
]}
